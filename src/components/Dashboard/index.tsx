...
export function Dashboard() {
  ...
  const natPatients = patients.filter(
    (patient) =>
    patient.nat.match(regexNat)
  )
  ...
  return (
    <Container>
      ...
      <div className="filters">        
        ...
        <FormControl variant="outlined" id="last" className={classes.formControl}>
          <InputLabel id="demo-simple-select-outlined-label">Nationality</
          InputLabel>
          <Select            
            labelId="demo-simple-select-outlined-label"            
            id="demo-simple-select-outlined"            
